...
# this file is used to load a model (weights) from a checkpoint hdf5 file and predict the sign language real
# time based on a input image file
...
# path to the dataset
paths = ['/home/pranav/Development/Final-year-project/ASL-Finger-Spelling-Recognition-master/asl_dataset']
TOTAL_DATASET = 350  # (default: 2515)
        ...
        for root, directories, filenames in os.walk(path):
            for filename in filenames:
                if filename.endswith(".jpeg"):
                    ...
                    print 'img bytes:', img.nbytes  #print number of bytes of each image array
                    x_train.append(img)
                    t = fullpath.rindex('/')
...
def train_model(model, X_train, Y_train):
    ...
    model.load_weights("weights.09.hdf5")   #load the earlier saved weights
...
def trainData():
    ...
    print 'y_train number of bytes:', a.nbytes
    ...
    # model.save('/home/pranav/Development/Final-year-project/ASL-Finger-Spelling-Recognition-master/keras.model')

    # run this if model is already saved on disk.
    # model = keras.models.load_model('/home/pranav/Development/Final-year-project/ASL-Finger-Spelling-Recognition-master/keras.model')
...
# load a sample image file for classification

# preprocess the image first
# img = load_img('/home/pranav/Development/Final-year-project/ASL-Finger-Spelling-Recognition-master/asl_dataset/0/hand1_0_bot_seg_2_cropped.jpeg') # 0
# img = load_img('/home/pranav/Development/Final-year-project/ASL-Finger-Spelling-Recognition-master/asl_dataset/2/hand1_2_bot_seg_1_cropped.jpeg') # 2
# img = load_img('/home/pranav/Development/Final-year-project/ASL-Finger-Spelling-Recognition-master/asl_dataset/1/hand1_1_bot_seg_1_cropped.jpeg') # 1
img = load_img('/home/pranav/Development/Final-year-project/ASL-Finger-Spelling-Recognition-master/asl_dataset/3/hand1_3_dif_seg_1_cropped.jpeg') # 3

img = img_to_array(img)
xtrain = []
xtrain.append(img)

xtrain = numpy.asarray(xtrain).astype('float32')
xrain = xtrain / 255.0
...
predictions = model.predict_classes(xtrain)

print predictions



# # uncomment below lines if you just want to create the model file
