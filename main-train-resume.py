...
TOTAL_DATASET = 2515  # (default: 2515)
x_train = []  # training lists
y_train = []
nb_classes = 36  # number of classes (default: 36)
img_rows, img_cols = 400, 400  # size of training images
img_channels = 3  # BGR channels
batch_size = 1 # batch size (default: 32)
...
def train_model(model, X_train, Y_train):
    ...
    model.load_weights("weights.04.hdf5")   # specify the weights file of last checkpoint here (h5py python library is required for this)
